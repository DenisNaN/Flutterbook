...
class AppointmentsEntry extends StatelessWidget {
  ...
  final TextEditingController _apptDateEditingController =
      TextEditingController();
  final TextEditingController _apptTimeEditingController =
      TextEditingController();
  ...
  AppointmentsEntry() {
    ...
    _apptDateEditingController.addListener(() {
      appointmentsModel.entityBeingEdited.apptDate =
          _apptDateEditingController.text;
    });
    _apptTimeEditingController.addListener(() {
      appointmentsModel.entityBeingEdited.apptTime =
          _apptTimeEditingController.text;
    });
  }
                    ...
                    ListTile(
                        ...
                        title: TextFormField(
                            ...
                            validator: (inValue) {
                              ...
                              inModel.entityBeingEdited.title =
